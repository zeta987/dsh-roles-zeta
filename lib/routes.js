 ...
 * the route does not offer moves to the nearest level, preferring the higher one
 * on a tie, so a request never lands below what it asked for when the route
 * offers a level just above it: on off/low/high/max, `medium` becomes `high`.
